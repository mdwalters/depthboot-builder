    ...
    while True:
        ...
        match distro_name:
            ...
            case "Linux Mint (Cinnamon edition)":
                ...
                user_selection = ia_selection("This option does *NOT* actually install Linux Mint. It will install "
                                              "normal Ubuntu 22.04 (which is what Linux Mint is based on) with the "
                                              "Cinnamon desktop environment (which is used by Linux Mint).\n Are you "
                                              "sure you want to continue?", options=["No", "Yes"], )
